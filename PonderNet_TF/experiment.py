...
class Configs(object):
    def __init__(self,**kwargs):
        ...
        self.model = PPG.ParityPonderGru(self.n_elems, 
                                         self.n_hidden, 
                                         self.max_steps)
        self.loss_rec = RCL.ReconstructionLoss(tf.keras.losses.BinaryCrossentropy(from_logits=True,
    ...
    def ProgBar(self):
        self.stateful_metrics =['train_loss', 'train_loss_reg','train_expected_steps','val_loss','val_loss_reg','train_acc','val_acc','val_expected_steps']
    ...
    def run(self) -> dict:
        ...
        for epoch in range(self.epochs):
            ...
            for step, (batch_X_train, batch_Y_train) in enumerate(self.train_loader):
                ...
                values=[('train_loss',train_loss_rec),('train_loss_reg',train_loss_reg),('train_expected_steps',train_expected_steps)]
            ...
            values += [('val_loss',val_loss_rec),('val_loss_reg',val_loss_reg),('val_expected_steps',val_expected_steps),('val_acc',val_acc)]
...
def main():
    experiment = Configs(learning_rate=7e-4)
